...
public class Mystère {
    ...
    public static int restart2(){
       ...
       int reponse;
		...
		System.out.println("Votre but est de devinez le mot magique");
		System.out.println("La premiere lettre est " +word.charAt(0));
		System.out.println("========================================");
		...
		{
		Scanner sc =new Scanner(System.in);
		System.out.println("Entrez une tentative \n nombre de coups restant: "+ limite);limite--;
                end();
		essai=sc.nextLine();
		essai = ""+essai;
		
		if (!(essai.equals(word))) { System.out.println("Ce n'est pas le mot magique"); count++; end();}
		
		if(essai.equals(word)) { System.out.println("Bravo vous avez trouvé le mot"); count = 0;limite = 0; }
		...
		{
		Scanner sc =new Scanner(System.in);
		System.out.println("Entrez une tentative");end();
		essai=sc.nextLine();
		essai = ""+essai;
		
		if (!(essai.equals(word))) { System.out.println("Ce n'est pas le mot magique"); count++; end();}
		
		if(essai.equals(word)) { System.out.println("Bravo vous avez trouvé le mot"); count = 0; end();}
         ...
         public static int TotalLinesNumber()
	{
		...
		try
		{
			File f = new File("./src/com/Projet/dictionnaire.txt");
